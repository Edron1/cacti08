...
cacti_log("WARNING: 2.",$print_data_to_stdout);
$_SESSION["sess_config_array"]["log_verbosity"] = 10;
$config["config_options_array"]["log_verbosity"] = 10;

if (read_config_option("log_verbosity") >= POLLER_VERBOSITY_DEBUG) {
cacti_log("WARNING: 1.",$print_data_to_stdout);
}
