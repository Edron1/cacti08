...
function create_complete_graph_from_template($graph_template_id, $host_id, $snmp_query_array, &$suggested_values_array) {
	...
	if (isset($suggested_values_array[$graph_template_id]["graph_template"])) {
		foreach ($suggested_values_array[$graph_template_id]["graph_template"] as $field_name => $field_value) {
	...
	if (isset($suggested_values_array[$graph_template_id]["graph_template_item"])) {
		foreach ($suggested_values_array[$graph_template_id]["graph_template_item"] as $graph_template_item_id => $field_array) {
	...
	foreach ($data_templates as $data_template) {
		...
		if (isset($suggested_values_array[$graph_template_id]["data_template"]{$data_template["id"]})) {
			...
			foreach ($suggested_values_array[$graph_template_id]["data_template"]{$data_template["id"]} as $field_name => $field_value) {
		...
		if (isset($suggested_values_array[$graph_template_id]["data_template_item"])) {
			...
			foreach ($suggested_values_array[$graph_template_id]["data_template_item"] as $data_template_item_id => $field_array) {
				foreach ($field_array as $field_name => $field_value) {
		...
		if (isset($suggested_values_array[$graph_template_id]["custom_data"]{$data_template["id"]})) {
			...
			foreach ($suggested_values_array[$graph_template_id]["custom_data"]{$data_template["id"]} as $data_input_field_id => $field_value) {
